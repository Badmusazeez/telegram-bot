#!/usr/bin/env node
/**
 * One-command local runner for your system terminal.
 * Checks Node + .env, installs deps if needed, then starts the bot.
 *
 * Usage: npm run bot
 */
...
console.log("");
console.log("=== Starting Ethereum NFT Copy Bot (local terminal) ===");
