...
└── examples/
    ...
    └── my_first_thru_program.c  # Program source code
```
...
```bash
# Upload the program
thru uploader upload <seed> build/thruvm/bin/my_first_thru_program_c.bin

# Create a managed program
thru program create <seed> build/thruvm/bin/my_first_thru_program_c.bin
```

## Development

Edit `examples/my_first_thru_program.c` to modify your program logic.
