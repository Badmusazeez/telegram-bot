...
/** Default absolute ceiling — allows complex SeaDrop/multicall max-mints (~1.2M) with headroom. */
 ...
 *
 * - Rejects if estimate alone exceeds the absolute ceiling (abnormal).
 * - Applies marginPct, then caps gasLimit at the ceiling.
 * - Does NOT invent a fake estimate.
 */
