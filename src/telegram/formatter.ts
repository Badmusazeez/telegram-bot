...
export function helpText(): string {
  return [
    ...
    `/balances — mint wallet balances + $ USD (USDC≈$1)`,
    `/consolidate [0x?] — sweep USDC from mint keys → funding/to address`,
    `/disburse &lt;amountUSDC&gt; [all|1 2|0x…] — fund mint keys from funding wallet`,
    `/disburseall &lt;amountUSDC&gt; — fund every mint key with amount each`,
