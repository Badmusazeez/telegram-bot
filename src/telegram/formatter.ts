...
export function helpText(): string {
  return [
    ...
    ``,
    `Tracks whale wallets and auto-copies <b>free mints only</b> on Robinhood Chain (OpenSea / Scatter / contract / site). Always tries <b>max</b> free qty. Paid buys are skipped.`,
