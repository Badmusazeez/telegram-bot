...
- EMA 20/50/100/200 alignment filters
- Market structure (HH/HL/LH/LL, BOS, CHoCH)
- SMC zones (order blocks, FVG, breakers, mitigation, premium/discount)
- Liquidity sweeps (EQH/EQL, PDH/PDL, session levels)
...
- Confidence score 0–100 (minimum 66)
...
- Plugin hooks for future whale, news, calendar, dashboard, and backtest modules
...
- Long: HTF bullish + EMA stack aligned + price above EMA20 + bullish zone revisit + liquidity sweep low + supportive order flow + volume/ATR OK
- Short: mirror conditions
- Reject flat/intertwined EMAs, low-volume breakouts, sharp OI decline on breakouts, crowded funding when confidence is weak
- Min confidence **66**, preferred **90+**
